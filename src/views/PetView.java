...
public class PetView {
    ...
    private void createPet() {
        try {
            ...
            Pet newPet = new Pet(name, species, race, gender, age, idClient);
    ...
    private void readAllPets() {
        ...
        if (pets.isEmpty()) {
            ...
            System.out.printf("%-5s %-20s %-15s %-15s %-10s %-5s %-10s\n",
                    "ID", "Nombre", "Especie", "Raza", "Género", "Edad", "ID Dueño");
            pets.forEach(pet -> System.out.printf("%-5d %-20s %-15s %-15s %-10s %-5d %-10d\n",
                    pet.getId(), pet.getName(), pet.getSpecies(), pet.getRace(),
                    pet.getGender(), pet.getAge(), pet.getIdClient()));
        }
    }
    ...
    private void updatePet() {
        try {
            ...
            if (pet != null) {
                ...
                Pet updatedPet = new Pet(name, species, race, gender, age, pet.getIdClient());
                updatedPet.setId(id); 
